        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.resetpwd_btn_cancel:                     //取消按钮的监听事件,由注册界面返回登录界面
                    Intent intent_Resetpwd_to_Login = new Intent(ResetPassword.this,Login.class) ;    //切换Resetpwd Activity至Login Activity
                   ...
                   // UserData mUser = new UserData(userName, userPwd_new);
                    ...
                    if (flag == false) {
                     ...
                     //   mUser.pwdresetFlag=1;
                        Intent intent_Register_to_Login = new Intent(ResetPassword.this,Login.class) ;    //切换User Activity至Login Activity
